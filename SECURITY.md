...
Security fixes are provided for **currently supported release lines** of `switon/pool` (`switon/pool` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/pool/security/advisories/new)
