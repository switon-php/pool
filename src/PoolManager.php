 ...
 *
 * @implements PoolManagerInterface<object, object>
 */
class PoolManager implements PoolManagerInterface
{
    ...
    /**
     * Removes one pool type or every pool for the owner.
     */
    ...
    /**
     * Creates an empty pool with the requested capacity for the owner and type.
     */
    ...
    /**
     * Seeds a pool with one or more resource instances, creating the pool automatically when needed.
     */
    ...
    /**
     * Returns a borrowed resource to its pool and emits success or failure lifecycle events.
     */
    ...
    /**
     * Acquires one resource from the pool, optionally waiting until the timeout expires.
     */
    ...
    /**
     * Acquires a resource and wraps it in a scoped guard that auto-returns it later.
     */
    ...
    /**
     * Returns whether the pool currently has no available resources.
     */
    ...
    /** Returns whether the owner/type pool exists. */
    public function exists(object $owner, string $type = 'default'): bool
    {
        return isset($this->pools[$owner][$type]);
    }

    /** Returns the configured capacity for the owner/type pool. */
