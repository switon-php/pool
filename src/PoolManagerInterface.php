 ...
 *
 * Guidance:
 * - use <code>guard()</code> as the default borrow path and reserve explicit <code>acquire()</code>/<code>release()</code> for manual lifecycle cases
 * - omit <code>$type</code> when one owner has only one logical pool, and introduce named types only for real variants
 *
 * Use when you need:
...
interface PoolManagerInterface
{
     ...
     *
     * @param object $owner Pool owner object
     * @param TResource|array{0: class-string, 1?: array<string, mixed>} $sample Connection instance or [className, parameters]
     ...
     *
     * @param object $owner Pool owner object
     * @param TResource $instance Resource instance to return
     * @param string $type Pool type identifier
     ...
     * @param string $type Pool type identifier
     *
     * @return TResource Resource instance
     *
     * @throws PoolNotFoundException If pool doesn't exist
     ...
     *
     * @param TParent $owner Pool owner object
     * @param float|null $timeout Timeout in seconds, null for blocking
     * @param string $type Pool type identifier
     *
     * @return PoolGuard<TParent, TResource> Pool guard with auto-return capability
     *
     * @throws PoolNotFoundException If pool doesn't exist
     * @throws BusyException If no resources available within timeout
     */
